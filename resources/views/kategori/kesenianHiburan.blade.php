...
@section('content')
    <main class="py-8">
        <div class="max-w-[1600px] mx-auto px-12 md:px-24 lg:px-32 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            @if ($terbaru->count() || $rekomendasi->count() || $terpopuler_kesenian->count() || $terpopuler_hiburan->count())
                {{-- TERBARU & REKOMENDASI --}}
                <div class="md:col-span-1">
                    ...
                    @if ($terbaru->count())
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{ route('kesenian-hiburan.semua') }}"
                ...
                <div class="md:col-span-2 -mt-2">
                    @if ($terpopuler_kesenian->count() || $terpopuler_hiburan->count())
