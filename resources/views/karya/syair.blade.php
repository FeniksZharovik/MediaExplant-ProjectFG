        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4">
                            @foreach ($terbaru as $item)
                                <div class="flex flex-col items-start w-full">
                                    <a href="{{ route('karya.syair.read', ['k' => $item->id]) }}" class="w-full">
                            ...
                            <div class="mt-6 w-full flex justify-center col-span-full">
                                <a href="{{ route('karya.syair.semua') }}"
            ...
            @else
                ...
                <div class="col-span-3 flex flex-col items-center justify-center py-20 text-center text-gray-500">
                    ...
                    <h2 class="text-lg font-semibold">Belum ada karya syair yang tersedia.</h2>
                    <p class="text-sm mt-1">Silakan periksa kembali nanti untuk melihat karya terbaru.</p>
                </div>
            @endif
        </div>
    </div>
